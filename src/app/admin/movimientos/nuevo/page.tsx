  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-tenue">
        Registra un ingreso o egreso independiente al costo de un evento. Queda
        en estado <strong>pendiente</strong> hasta que un admin lo apruebe; solo
        los aprobados cuentan en el balance.
      </p>
      <MovimientoForm action={crearMovimiento} eventos={eventos} />
    </div>
  );
}
